...
$sql2="SELECT * FROM admin where username='$hardwell'";
$sql3="SELECT * FROM pelanggan where username='$hardwell'";
...
$sql2="SELECT * FROM pemesanan where status='Tunggu Pembayaran' group by id_pelanggan ORDER BY id_pemesanan desc";
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					...
					<?php if($nervo==1){?>
						<li><a href="index.php?r=admin" class="active"><i class="lnr lnr-home"></i> <span>Beranda</span></a></li>
						
						<li><a href="index.php?r=produk/admin" class=""><span>Produk</span></a></li>
						<li><a href="index.php?r=kategori/admin" class=""><span>Kelola Kategori</span></a></li>
					...
					<?php if($nervo2==2){?>
						...
						<li><a href="#" class=""><span>Pesanan Saya</span></a></li>
						<li><a href="#" class=""><span>Beranda</span></a></li>
					<?php }?>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											...
											<span class="title">Stok Gudang</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
