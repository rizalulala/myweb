	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="index.php?r=admin"><i class="lnr lnr-home"></i> <span>Beranda</span></a></li>
						<li><a href="index.php?r=product/admin" class=""><span>Products</span></a></li>
						<li><a href="index.php?r=orders/admin" class="active"><span>Orders</span></a></li>
				...
				<div class="container-fluid">
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="css/admin/assets/img/user.png" class="img-circle" alt="Avatar"> <span><?php echo ''.Yii::app()->User->name.'' ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
								<ul class="dropdown-menu">
