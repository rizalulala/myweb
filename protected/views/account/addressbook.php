...
<div style="padding:5px 10px 0 0;margin:5px 5px 15px 5px; border:1px solid #CCC;text-align: justify;">
	<strong style="margin-left:4px;float:left;">Buku Alamat Anda</strong> 
	<div style="clear:left;margin:0 5px 0 5px;text-align: right">
		<a href="<?php echo $this->createUrl('account/addressbook',array('add'=>'addressbook'));?>">Tambahkan Alamat Baru</a>
	</div>
	<?php 
