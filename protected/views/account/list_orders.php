...
<div style="padding:5px 10px 0 0;margin:5px 5px 15px 5px; border:1px solid #CCC;text-align: justify;">
	<strong style="margin-left:4px;float:left;padding: 0 0 15px 0;">Order history anda</strong>
...
?>
	...
	<div class="search-form" style="margin-left: 5px;">
		<?php $form = $this -> beginWidget('CActiveForm', 
			...
			<?php echo $form -> textField($model, 'order_code',array('placeholder'=>'cari berdasarkan order code','size'=>30)); ?>
