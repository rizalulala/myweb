					...
					<a href="single.php"><div class="product-img">
						...
						<div class="p-mask">
							<form action="#" method="post">
								...
								<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true" style="color: #fff"></i> <a href="basket.php" style="color: #fff"> Add to cart </a></button>
							</form>
						</div>
					</div></a>
